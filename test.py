...
if __name__ == "__main__":
    ...
    TEST_BATCH_OUTPUT = "result_swinir/swinir_med_4x_medical_11/test_output_amp"
    BEST_MODEL = "result_swinir/swinir_med_4x_medical_11/swinir_med_4x_sr_amp_best.pth"
